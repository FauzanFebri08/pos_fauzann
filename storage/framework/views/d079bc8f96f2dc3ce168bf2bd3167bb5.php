    ...
    <div class="card border-0 shadow-sm rounded-4 p-3">
        ...
        <div class="card-body bg-primary text-white rounded-4 p-4 mb-4 d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="mb-0 text-white-50 small">Kelola informasi akun dan kata sandi Anda.</p>
            </div>
        </div>

        <?php if(session('success')): ?>
            <div class="alert alert-success alert-dismissible fade show rounded-3 ms-2 me-2" role="alert">
...
unset($__errorArgs, $__bag); ?>
                ...
                <hr class="my-4">
                <h5 class="fw-bold text-dark mb-3">Ubah Password <span class="text-muted fs-6 fw-normal">(Kosongkan jika tidak ingin mengubah)</span></h5>
...
unset($__errorArgs, $__bag); ?>" placeholder="Masukkan password lama">
...
unset($__errorArgs, $__bag); ?>" placeholder="Minimal 8 karakter">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-4">
                    <button type="submit" class="btn btn-primary w-100 rounded-3 fw-bold py-2">Simpan Perubahan</button>
                </div>
            </form>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\finall\resources\views/profile/edit.blade.php ENDPATH**/ ?>